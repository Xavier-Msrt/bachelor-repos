...
const PRODUCTION_API_BASE_URL = '/path_production/'; // to be changed to point to the URL of your API
...
const PRODUCTION_PATH_PREFIX = '/path_production/'; // e.g. '/mymovies/' if you deploy to GitHub Pages as a Project site : mymovies would be the repo name

const buildMode = process.argv[process.argv.indexOf('--mode') + 1];
const isProductionBuild = buildMode === 'production';

const PATH_PREFIX = isProductionBuild ? PRODUCTION_PATH_PREFIX
    : DEVELOPMENT_PATH_PREFIX;
const API_BASE_URL = isProductionBuild ? PRODUCTION_API_BASE_URL
