...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("## PARTIE getPlatsParType ##");
		livre.ajouterPlat(new Plat("Bolo", 4, Difficulte.X, Cout.$, Plat.Type.PLAT));

		System.out.println("Tout les PLAT");
		System.out.println(livre.getPlatsParType(Plat.Type.PLAT));

		livre.ajouterPlat(new Plat("Soupe tomat", 4, Difficulte.X, Cout.$, Plat.Type.ENTREE));
		System.out.println("Tout les ENTREE");
		System.out.println(livre.getPlatsParType(Plat.Type.ENTREE));


		System.out.println("## PARTIE getPlatsParType ##");
		System.out.println("le Waterzooi est t'il dans le livre (true):" +livre.contient(plat));

		System.out.println("## PARTIE tousLesPlats ##");
		System.out.println("Il y a bien 4 plats dans notre livre ?: ");
		System.out.println(livre.tousLesPlats().size());
