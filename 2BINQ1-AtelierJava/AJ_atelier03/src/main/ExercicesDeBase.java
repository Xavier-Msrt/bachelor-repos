...
public class ExercicesDeBase {
    ...
    private void reduce1() {
        ...
        var s = transactions.stream()
                .map( e -> e.getValue())
                .reduce(Integer.MIN_VALUE,  Integer::max); // premier element de depars // deuxieme condition de comparaison
        System.out.println(s);
    }
    ...
    private void reduce2() {
        ...
        var s = transactions
                .stream()
                .reduce(new Transaction(null,2000 ,Integer.MAX_VALUE), (a,b) -> {
