...
public class TestLambda {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------- With allMatches, transformAll ---------");
      ...
      result = Lambda.allMatches(list, e ->  e > 200);
        ...
        result = Lambda.allMatches(list, e -> e.toString().charAt(0) == '1');
        System.out.println(result);
       ...
       //Trouve toutes les String de la liste qui commencent par "h"
        List<String> result2 = Lambda.allMatches(list2, e -> e.charAt(0) == 'l');
        System.out.println(result2);

        //Retourner une liste qui contient la taille de chacune des String de la liste originale
        List<Integer> result3 = Lambda.transformAll(list2, e -> e.toString().length());
       System.out.println(result3);
        ...
        System.out.println("--------- With filter, map ---------");
        ...
        //Trouve tous les entiers de la liste dont le premier chiffre est 1
        result = Lambda.filter(list, e -> e.toString().charAt(0) == '1');
        System.out.println(result);
        ...
        //Trouve toutes les String de la liste qui commencent par "h"
        List<String> result4 = Lambda.filter(list2, e -> e.charAt(0) == 'l');
        System.out.println(result2);

        //Retourner une liste qui contient la taille de chacune des String de la liste originale
        List<Integer> result5 = Lambda.map(list2, e -> e.toString().length());
        System.out.println(result3);
